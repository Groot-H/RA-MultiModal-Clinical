...
# Retrieval-Augmented Multimodal Deep Learning for Interpretable Lung Nodule Malignancy Prediction

This repository contains the implementation code for the paper: **Retrieval-Augmented Multimodal Deep Learning for Interpretable Lung Nodule Malignancy Prediction**.
...
3.  **Attributes**: The following 8 columns are raw clinical attribute scores:
      * Subtlety
      * Internal structure
      * Calcification
      * Sphericity
